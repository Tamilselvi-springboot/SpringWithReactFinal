...
public class allData {
	...
	ConcurrentHashMap<String,testcaseResult> allProcessedScenarios = new ConcurrentHashMap<String,testcaseResult>();

	
	public ConcurrentHashMap<String, testcaseResult> getAllProcessedScenarios() {
		return allProcessedScenarios;
	}
	public void setAllProcessedScenarios(ConcurrentHashMap<String, testcaseResult> allProcessedScenarios) {
		this.allProcessedScenarios = allProcessedScenarios;
	}
